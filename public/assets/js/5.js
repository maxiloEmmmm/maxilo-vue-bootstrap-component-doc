...
Component.options.__file = "src/pages/test/dragTree.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-4f5a707b", Component.options)
  } else {
    hotAPI.reload("data-v-4f5a707b", Component.options)
  }
...
var render = function() {
  ...
  return _c("mxl-tree", { attrs: { data: _vm.data, useDrag: "true" } })
}
var staticRenderFns = []
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-loader/node_modules/vue-hot-reload-api")      .rerender("data-v-4f5a707b", module.exports)
  }
}
