...
exports.default = {
    ...
    computed: {
        ths: function ths() {
            return {
                demo1: [{ field: 'id', title: 'ID', sort: true }, { field: 'username', title: '用户名', width: '10%', align: 'left' }, { field: 'age', title: '年龄', hide: true }, { field: 'sex', title: '性别', tdSlot: 'sexSlot' }, { title: '操作', tdSlot: 'opearSlot' }],
